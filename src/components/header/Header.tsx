        ...
        <header className="my-4 border mx-2 lg:mx-4 flex justify-between items-center py-6 rounded-2xl px-4 lg:px-8 bg-card/80 z-50 backdrop-blur-md sticky top-3">
            ...
            <NavigationMenu className="hidden lg:flex  ">
                <NavigationMenuList className="flex text-sm">
                    <NavigationMenuItem>
                        <Button variant="ghost" asChild><NavigationMenuLink asChild><Link href={"/"}>Home</Link></NavigationMenuLink></Button>
                    </NavigationMenuItem>
                    <NavigationMenuItem>
                        <Button variant="ghost" asChild><NavigationMenuLink asChild><Link href={"material"}>Material Complementar</Link></NavigationMenuLink></Button>
                    </NavigationMenuItem>
                    <NavigationMenuItem>
